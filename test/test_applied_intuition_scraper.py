...
@pytest.fixture
def scraper():
    """Fixture to create a ScrapeAppliedIntuition instance."""
    return ScrapeAppliedIntuition()


@pytest.fixture
def company():
    """Fixture to create an Applied Intuition CompanyItem."""
    return CompanyItem("applied_intuition", "https://www.appliedintuition.com/careers#job-listings", Scrapers.APPLIED_INTUITION, "https://www.appliedintuition.com")


def test_applied_intuition_scraper(driver, scraper, company):
    """Test Applied Intuition scraper to verify job extraction."""
    # Act
