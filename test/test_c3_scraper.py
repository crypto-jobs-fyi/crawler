...
@pytest.fixture
def scraper():
    """Fixture to create a ScrapeC3 instance."""
    return ScrapeC3()


@pytest.fixture
def company():
    """Fixture to create a C3.ai CompanyItem."""
    return CompanyItem('c3.ai', 'https://c3.ai/careers', Scrapers.C3, 'https://c3.ai')


def test_c3_scraper(driver, scraper, company):
