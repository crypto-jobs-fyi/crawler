...
@pytest.fixture
def scraper():
    """Fixture to create a ScrapeLmax instance."""
    return ScrapeLmax()


@pytest.fixture
def company():
    """Fixture to create an LMAX CompanyItem."""
    return CompanyItem('lmax', 'https://careers.lmax.com/job-openings', Scrapers.LMAX, 'https://www.lmax.com')


def test_lmax_scraper(driver, scraper, company):
    """Test LMAX scraper to verify job extraction."""
    # Act
