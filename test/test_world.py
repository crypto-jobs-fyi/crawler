...
@pytest.fixture
def scraper():
    """Fixture to create a ScrapeWorld instance."""
    return ScrapeWorld()


@pytest.fixture
def company():
    """Fixture to create a Worldcoin CompanyItem."""
    return CompanyItem("worldcoin", "https://world.org/careers", Scrapers.WORLDCOIN, "https://world.org")


def test_world_scraper(driver, scraper, company):
    """Test Worldcoin scraper to verify job extraction."""
    # Act
