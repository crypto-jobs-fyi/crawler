...
def get_company_list() -> list[CompanyItem | Any]:
    return [
        ...
        CompanyItem('cryptio', 'https://jobs.ashbyhq.com/cryptio', ScrapeAshbyhq, 'https://cryptio.co'),
        CompanyItem('matterlabs', 'https://jobs.ashbyhq.com/matter-labs', ScrapeAshbyhq, 'https://matter-labs.io'),
        CompanyItem("iftother", "https://boards.greenhouse.io/iftother", ScrapeGreenhouse,
                    "https://free.technology"),
        CompanyItem("nimbus", "https://job-boards.greenhouse.io/nimbus", ScrapeGreenhouse,
                    "https://free.technology/nimbus"),
        CompanyItem("figure", "https://job-boards.greenhouse.io/figure", ScrapeGreenhouse,
        ...
        CompanyItem('xlabs', 'https://jobs.ashbyhq.com/Xlabs', ScrapeAshbyhq,
                    'https://www.xlabs.xyz'),
        CompanyItem('orca', 'https://jobs.ashbyhq.com/orca', ScrapeAshbyhq, 'https://www.orca.so'),
        ...
        CompanyItem("coinmarketcap", "https://jobs.lever.co/coinmarketcap",
                    ScrapeLever, "https://coinmarketcap.com"),
        ...
        CompanyItem("magiceden", "https://jobs.ashbyhq.com/magiceden", ScrapeAshbyhq,
                    "https://www.magiceden.io"),
        CompanyItem("aztec", "https://boards.eu.greenhouse.io/aztec", ScrapeGreenhouse,
                    "https://aztec.network"),
        CompanyItem('near', 'https://job-boards.eu.greenhouse.io/nearfoundation', ScrapeGreenhouse,
                    'https://near.org'),
        CompanyItem("nethermind", "https://jobs.ashbyhq.com/nethermind", ScrapeAshbyhq,
                    "https://nethermind.io"),
        CompanyItem("dfinity", "https://boards.greenhouse.io/dfinity", ScrapeGreenhouse, "https://dfinity.org"),
        CompanyItem('stellar', 'https://jobs.ashbyhq.com/stellar', ScrapeAshbyhq, 'https://stellar.org'),
        CompanyItem('bitcoindepot', 'https://job-boards.greenhouse.io/bitcoindepot', ScrapeGreenhouse, 'https://bitcoindepot.com'),
        CompanyItem("parity", "https://jobs.ashbyhq.com/parity", ScrapeAshbyhq, "https://www.parity.io"),
        CompanyItem("oplabs", "https://jobs.ashbyhq.com/oplabs", ScrapeAshbyhq, "https://www.oplabs.co"),
        CompanyItem('walletconnect', 'https://apply.workable.com/reown', ScrapeWorkable,
                    'https://reown.com'),
