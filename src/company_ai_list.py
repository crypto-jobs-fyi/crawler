...
def get_company_list() -> list[CompanyItem]:
    return [
        ...
        CompanyItem('Crusoe', 'https://jobs.ashbyhq.com/Crusoe', ScrapeAshbyhq, 'https://www.crusoe.ai'),
        ...
        CompanyItem("multiverse", "https://jobs.ashbyhq.com/multiverse", ScrapeAshbyhq, "https://www.multiverse.io"),
    ]
