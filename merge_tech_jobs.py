...
# Main output file for Tech jobs
jobs_file = 'tech_jobs.json'

logger.info(
    "Starting Tech jobs merge",
...
# List of files to merge into the main tech_jobs.json
job_json_list = [
    'tech_jobs.json',
    'headed_tech_jobs.json'
]
